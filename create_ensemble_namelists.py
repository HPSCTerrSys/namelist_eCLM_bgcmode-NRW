...
def write_datm_in(
        ...
        eyear,
        iens,
        domname="domain.lnd.10x10_wuestebach_10x10_wuestebach.220125.nc"):
    nl_string = ''
    nl_string += '&datm_nml\n'
    nl_string += '  decomp = "1d"\n'
    ...
    nl_string += ('  domainfile = "' + str(os.getcwd()) + '/input_clm/' +
                  domname + '"\n')
    ...
    nl_string += (
        '  streams = "user_datm.streams.clm1PT.10x10Wue.solar.stream_' +
        str(iens).zfill(4) + '.txt 2009 2009 2009",\n' +
        '"user_datm.streams.clm1PT.10x10Wue.precip.stream_' +
        str(iens).zfill(4) + '.txt 2009 2009 2009",\n' +
        '"user_datm.streams.clm1PT.10x10Wue.other.stream_' +
        str(iens).zfill(4) + '.txt 2009 2009 2009",\n')
...
def write_drv_flds_in():
    ...
    nl_string += ("  megan_factors_file = '" + str(os.getcwd()) +
                  "/input_clm/cesm/megan21_emis_factors_78pft_c20161108.nc'\n")
...
def write_drv_in(rundir, syear, eyear, prefix=None):
    ...
    # outpathroot: deprecated input, not used for output placing
    nl_string += '  outpathroot = "' + rundir + '/"\n'
    ...
    nl_string += '  stop_ymd = ' + str(eyear) + '0111\n'
...
def write_lnd_in(syear, eyear, iens, prefix="nrw_300x300"):
    nl_string = ""
    ...
    nl_string += " fatmlndfrc = '" + str(os.getcwd(
    )) + "/input_clm/domain.lnd.10x10_wuestebach_10x10_wuestebach.220125.nc'\n"
    nl_string += " finidat = ''\n"
    nl_string += " fsnowaging = '" + str(
        os.getcwd()) + "/input_clm/cesm/snicar_drdt_bst_fit_60_c070416.nc'\n"
    nl_string += " fsnowoptics = '" + str(
        os.getcwd()) + "/input_clm/cesm/snicar_optics_5bnd_c090915.nc'\n"
    nl_string += " fsurdat = '" + str(
        os.getcwd()
    ) + "/input_clm/surfdata_300x300_NRW_hist_78pfts_CMIP6_simyr2000_c190619_" + str(
        iens).zfill(5) + ".nc'\n"
    ...
    nl_string += " hist_fincl1 = 'H2OSOI'\n"
    nl_string += " hist_dov2xy = .true.\n"
    nl_string += " hist_type1d_pertape = ' '\n"
    nl_string += " hist_mfilt = 480\n"
    nl_string += " hist_nhtfrq = 1\n"
    nl_string += " hist_avgflag_pertape = 'I'\n"
    nl_string += " hist_fincl2 = 'H2OSOI'\n"
    nl_string += " hist_dov2xy(2) = .false.\n"
    nl_string += " hist_type1d_pertape(2) = 'COLS'\n"
    nl_string += " hist_mfilt(2) = 480\n"
    nl_string += " hist_nhtfrq(2) = 1\n"
    nl_string += " hist_avgflag_pertape(2) = 'I'\n"
    ...
    nl_string += " paramfile = '" + str(
        os.getcwd()) + "/input_clm/cesm/clm5_params.c171117.nc'\n"
    ...
    nl_string += " stream_fldfilename_ndep = '" + str(
        os.getcwd()
    ) + "/input_clm/cesm/fndep_clm_hist_b.e21.BWHIST.f09_g17.CMIP6-historical-WACCM.ensmean_1849-2015_monthly_0.9x1.25_c180926.nc'\n"
    ...
    nl_string += " stream_fldfilename_popdens = '" + str(
        os.getcwd()
    ) + "/input_clm/cesm/clmforc.Li_2017_HYDEv3.2_CMIP6_hdm_0.5x0.5_AVHRR_simyr1850-2016_c180202.nc'\n"
    nl_string += " stream_year_first_popdens = 2000\n"
    nl_string += " stream_year_last_popdens = 2000\n"
    nl_string += "/\n"
    nl_string += "&urbantv_streams\n"
    nl_string += " stream_fldfilename_urbantv = '" + str(
        os.getcwd()
    ) + "/input_clm/cesm/CLM50_tbuildmax_Oleson_2016_0.9x1.25_simyr1849-2106_c160923.nc'\n"
    ...
    nl_string += " stream_fldfilename_lightng = '" + str(
        os.getcwd()
    ) + "/input_clm/cesm/clmforc.Li_2012_climo1995-2011.T62.lnfm_Total_c140423.nc'\n"
    ...
    nl_string += " stream_fldfilename_ch4finundated = '" + str(os.getcwd(
    )) + "/input_clm/cesm/finundated_inversiondata_0.9x1.25_c170706.nc'\n"
    nl_string += "/\n"
...
def write_stream_files(iens, stream):
    ...
    nl_string += '  </variableNames>\n'
    nl_string += '  <filePath>\n'
    nl_string += '     ' + str(os.getcwd()) + '/input_clm\n'
    nl_string += '  </filePath>\n'
    nl_string += '  <fileNames>\n'
    nl_string += '     domain.lnd.10x10_wuestebach_10x10_wuestebach.220125.nc\n'
    nl_string += '  </fileNames>\n'
    nl_string += '</domainInfo>\n'
    nl_string += '<fieldInfo>\n'
    nl_string += '   <variableNames>\n'
...
#        nl_string += '       FLDS lwdn\n'
    ...
    nl_string += '   <filePath>\n'
    nl_string += '     ' + str(
        os.getcwd()) + '/forcings/real_' + str(iens).zfill(5) + '\n'
    nl_string += '   </filePath>\n'
    nl_string += '   <fileNames>\n'
    ...
    with open(
            "user_datm.streams.clm1PT.10x10Wue." + stream + ".stream_" +
